  ...
  <div v-if="user">
    <div class="top">
      ...
      <div class="lists">
        ...
        <div class="list">
          ...
          <span>
            <el-button type="text" @click="dialogFormVisible = true" style="margin-top:-12px;">
              <span>通知</span>
            </el-button>
            <el-dialog title="选择订阅" :visible.sync="dialogFormVisible">
              <el-form :model="userSubscribe">
                <div>
                  <el-switch
                    v-model="userSubscribe.invitation"
                    inactive-text="邀请用户推送"
                ...
                <div>
                  <el-switch
                    v-model="userSubscribe.agree"
                    inactive-text="点赞评论推送"
                    @change="subscribeChange()"
                  ></el-switch>
                  <hr />
                </div>
                <div>
                  <el-switch
                    v-model="userSubscribe.orderStatus"
                    inactive-text="订单状态推送"
                    @change="subscribeChange()"
                  ></el-switch>
                </div>
              </el-form>
        ...
        <div class="list" @click="routerInvite">
          <div style="margin-bottom: 4px;">
            <svg
              class="icon"
              style="width: 20px; height: 20px;vertical-align: middle;fill: #FFFFFF;overflow: hidden;"
            ...
            >
              <path
                d="M444.424952 370.561687c-1.344624 0-2.690272-0.081864-4.034896-0.265036-44.832068-5.767354-109.186771-23.292496-161.111374-73.973782-35.499515-34.68394-47.929616-85.365226-32.441876-132.275629 16.425088-49.865711 61.216223-84.447321 119.743198-92.517113 31.463596-4.259 63.702857 6.195096 88.890516 28.815279 23.720238 21.376866 41.938158 42.285059 55.5512 64.313771 12.390191-18.258852 28.244274-36.517705 48.052412-55.5512 32.971949-31.668257 79.516008-44.262086 121.087822-32.951483 50.130747 13.613042 87.260389 49.417503 99.324146 95.77839 11.533684 44.445258-1.752924 92.109838-34.765805 124.368542-40.430828 39.432081-92.721775 64.089667-155.445328 73.320912-17.158798 2.587941-33.012881-9.31311-35.539424-26.430976-2.526543-17.0974 9.333576-32.992415 26.41051-35.518958 49.437969-7.254218 90.072435-26.145473 120.843252-56.142671 17.199731-16.85283 23.923876-40.71633 17.892509-63.845097-6.398734-24.718985-26.491351-43.344181-55.102992-51.129494-20.459984-5.461385-44.38386 1.426489-61.33902 17.688871-37.33328 35.886325-55.958476 65.332984-62.194504 98.529037-2.812045 14.794961-15.732309 25.493627-30.770817 25.493627-15.039531 0-27.958772-10.698666-30.770817-25.493627-6.439666-34.174334-20.011776-65.271586-65.129346-105.885586-11.249205-10.127661-25.635867-15.161305-38.433334-13.32754-34.846646 4.789073-59.953464 23.047926-68.87874 50.089815-7.907087 24.026206-1.467421 50.048883 16.791431 67.879993 41.571814 40.634466 96.389304 52.942793 125.326357 56.692187 17.158798 2.201132 29.263487 17.892509 27.062356 35.029818C473.402937 359.048469 459.912691 370.561687 444.424952 370.561687zM801.12698 953.402105 222.871997 953.402105c-35.010375 0-63.458287-31.524994-63.458287-70.264297L159.41371 499.168764 864.544335 499.168764l0 383.968022C864.544335 921.876088 836.096423 953.402105 801.12698 953.402105zM222.016513 561.771567l0 321.366242c0 5.095042 2.201132 7.743358 2.730181 8.110725l576.257489-0.448208c-1.140986-0.081864 0.937348-2.710738 0.937348-7.662517l-0.815575-321.366242L222.016513 561.771567zM838.21569 558.388517 185.78431 558.388517c-67.248613 0-121.943306-54.695716-121.943306-121.943306l0-6.540973c0-67.248613 54.695716-121.94433 121.943306-121.94433l652.432403 0c67.248613 0 121.943306 54.695716 121.943306 121.94433l0 6.540973C960.16002 503.6928 905.464303 558.388517 838.21569 558.388517zM185.78431 370.561687c-32.727379 0-59.341526 26.614148-59.341526 59.341526l0 6.540973c0 32.727379 26.614148 59.341526 59.341526 59.341526l652.432403 0c32.727379 0 59.341526-26.614148 59.341526-59.341526l0-6.540973c0-32.727379-26.614148-59.341526-59.341526-59.341526L185.78431 370.561687z"
                p-id="2937"
              />
            </svg>
          </div>
            ...
            <div class="header">
              <router-link to="/">
                <div class="head-portrait">
                  <img :src="user.cover" class="head-portrait-img" />
                </div>
              </router-link>
              <div class="name">
                <div class="username">{{user.wxName}}</div>
                <div class="recommend">
                ...
                <a href>
                  <div class="body-content">
                    <div class="book-cover">
                      <img src="../../assets/img/fdff05ea5bb411e782be00163e063441.jpeg" class="img" />
                    </div>
    ...
    <div class="tabbar">
      ...
      <router-link to="/cart">
        ...
        <v-count v-show="cartCount" class="shopping-cart-count" :cartCount="cartCount"></v-count>
      </router-link>
      <router-link to="/my">
...
export default {
  ...
  created() {
    ...
    this.$http.get("/user/subscribe").then(res => {
      if (res.code == 0) {
  ...
  methods: {
    ...mapActions(["getUserInfo", "getHasStockCartCount"]),
    logoutUser() {
      this.$router.push("/");
    ...
    async subscribeChange() {
      await this.$http.put("/user/subscribe", this.userSubscribe);
    }
  },
  computed: {
    ...mapGetters(["user", "cartCount"])
  },
  components: {
    VCount
  }
